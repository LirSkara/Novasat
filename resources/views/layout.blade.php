                                ...
                                <div class="search-select">
                                    <div class="select-position">
                                        <select id="select1">
                                            ...
                                            <option value="1">Видеокамеры</option>
                                            <option value="2">Регистраторы</option>
                                            <option value="3">Мониторы</option>
                                            <option value="4">Приставки</option>
                                ...
                                <ul id="nav" class="navbar-nav ms-auto">
                                    ...
                                    <li class="nav-item">
                                        <a class="dd-menu collapsed" href="javascript:void(0)" data-bs-toggle="collapse"
                                            ...
                                            aria-expanded="false" aria-label="Toggle navigation">Навигация</a>
                                        <ul class="sub-menu collapse" id="submenu-1-2">
                                            <li class="nav-item"><a href="about-us.html">О нас</a></li>
                                            <li class="nav-item"><a href="faq.html">Частые вопросы</a></li>
                                            <li class="nav-item"><a href="login.html">Авторизация</a></li>
                                            <li class="nav-item"><a href="register.html">Регистрация</a></li>
                                            <li class="nav-item"><a href="mail-success.html">Написать нам</a></li>
                                        </ul>
                                    </li>
                                    <li class="nav-item">
                                        <a class="dd-menu collapsed" href="javascript:void(0)" data-bs-toggle="collapse"
                                        ...
                                        <ul class="sub-menu collapse" id="submenu-1-3">
                                            <li class="nav-item"><a href="product-grids.html">Избранное</a></li>
                                            <li class="nav-item"><a href="product-list.html">Корзина</a></li>
                                            <li class="nav-item"><a href="product-details.html">Акции</a></li>
                                        </ul>
                                    </li>
                                    <li class="nav-item">
                        ...
                        <div class="col-lg-9 col-md-8 col-12">
                            <div class="footer-newsletter">
                                <h4 class="title">
                                    ...
                                    <span>Вы всегда будете в курсе всех новых акций</span>
                                </h4>
                                <div class="newsletter-form-head">
                                    <form action="#" method="get" target="_blank" class="newsletter-form">
                                        <input name="EMAIL" placeholder="Введите свою Email почту" type="email">
                                        <div class="button">
                                ...
                                <ul class="app-btn">
                                    <li>
                                        <a href="javascript:void(0)">
                                            ...
                                            <span class="small-title">Скачать из</span>
